...
public class CircleImageView extends ImageView {
	...
	public void displayWithUrl(String url,boolean isSave2Sdcard,boolean isSave2Memory) {

		ImageLoader.getInstance(mContext).DisplayImage(url, this,isSave2Sdcard,isSave2Memory);
	}
}