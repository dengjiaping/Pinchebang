...
import com.lepin.fragment.WorkFragment;
...
@Contextview(R.layout.work_fragment_activity)
public class WorkFragmentActivity extends BaseFragmentActivity implements OnClickListener {
	...
	@ViewInject(id = R.id.work_fragment_pager)
	private ViewPager mViewPager;

	@ViewInject(id = R.id.work_fragment_indicator)
	...
	protected void onCreate(Bundle arg0) {
		...
		mTitle.setText(getString(R.string.publishTitle) + "(" + getString(R.string.square_work)
				+ ")");
	...
	private void addFragments() {
		...
		fragments.add(WorkFragment.newInstance(Pinche.PASSENGER, key));
		fragments.add(WorkFragment.newInstance(Pinche.DRIVER, key));
	}
